 ...
 * @author Mishal
 */
public abstract class MapDoorsAnimationBase extends AnimationBase{
    ...
    public MapDoorsAnimationBase(GameObject gameObject, Dimension preferredSize, String assetFile){
        super();
