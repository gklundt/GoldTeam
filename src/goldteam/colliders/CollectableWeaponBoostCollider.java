 ...
 * @author faaez
 */
public class CollectableWeaponBoostCollider implements CollisionListener{
    ...
    public void DoCollision() {
        ...
        if (item instanceof CollectableWeaponBoost) {
    ...
    public void CollisionDetected(Collidable a, Collidable b) {
        if ((a instanceof CollectableWeaponBoost) && (b instanceof Boostable)) {
            this.collectableItem = a;
            this.movable = b;
            DoCollision();

        } else if ((b instanceof CollectableWeaponBoost) && (a instanceof Boostable)) {
