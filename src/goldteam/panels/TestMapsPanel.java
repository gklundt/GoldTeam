...
//
//        gameOverHud = new GameStageItem(gameData, new Point(10, 10));
//        GameStageAnimation goa = new GameStageAnimation(gameOverHud, gameData.getVisibleDimensions(), "assets/levelup.png");
//        gameOverHud.setWatcher(g1);
//        gameOverHud.setAnimator(goa);
//        gameOverHud.getWatcher().addDepletableListener((l) -> this.switchAnimation(gameOverHud));
//
