 ...
 * @author faaez
 */
public class CollectableHealthBoost extends GameObject implements Animatable, Collidable, CollectableItem {

    private AnimationBase animator;
    private Polygon collider;
    private final HashMap<Collidable, CollisionPlane> colliders;

    public CollectableHealthBoost(GameEngine gamedata, Point initialPoint) {
