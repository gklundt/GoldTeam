 ...
 * @author Caleb
 */
public class DebuffIndicator extends GameObject implements Animatable, BoostableWatcher{
    ...
    public DebuffIndicator(GameEngine gamedata, Point initialPoint) {
...
//        this.draw = this.watchedItem.isDebuffed;
