...
//        CharacterAnimationBase archerDefaultRight = new ArcherAnimationStanding(ar, gameData.getVisibleDimensions(), "assets/Archer/Archer_Standing_Right.png", charge, charge);
//        CharacterAnimationBase archerDefaultLeft = new ArcherAnimationStanding(ar, gameData.getVisibleDimensions(), "assets/Archer/Archer_Standing_Left.png", charge, charge);
//        CharacterAnimationBase archerWalkingRight = new ArcherAnimationStanding(ar, gameData.getVisibleDimensions(), "assets/Archer/Archer_Walking_Right.png", charge);
//        CharacterAnimationBase archerWalkingLeft = new ArcherAnimationStanding(ar, gameData.getVisibleDimensions(), "assets/Archer/Archer_Walking_Left.png", charge);
//        CharacterAnimationBase archerDrawingRight = new ArcherAnimationStanding(ar, gameData.getVisibleDimensions(), "assets/Archer/Archer_Drawing_Right.png", charge);
//        CharacterAnimationBase archerDrawingLeft = new ArcherAnimationStanding(ar, gameData.getVisibleDimensions(), "assets/Archer/Archer_Drawing_Left.png", charge);
