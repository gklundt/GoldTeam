 ...
 * @author Mishal
 */
public abstract class PotionAnimationBase extends AnimationBase{
     ...
     protected int imgHeight;
      ...
      public PotionAnimationBase(GameObject gameObject, Dimension preferredSize, String assetFile){
        super();
