 ...
 * @author faaez
 */
public class CollectablePermanentWeaponBoost extends GameObject implements Animatable, Collidable, CollectableItem {

    private AnimationBase animator;
    private Polygon collider;
    private final HashMap<Collidable, CollisionPlane> colliders;

    public CollectablePermanentWeaponBoost(GameEngine gamedata, Point initialPoint) {
